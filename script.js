...
class ChamadoProApp {
    constructor() {
        ...
        this.providerData = {
            ...
            specialties: [
                { name: "Encanador", level: "Avançado", experience: "5 anos" },
                { name: "Eletricista", level: "Intermediário", experience: "3 anos" },
                { name: "Pedreiro", level: "Básico", experience: "2 anos" }
            ],
            earnings: {
                thisMonth: 1250.00,
                lastMonth: 2100.00,
...
function showMySpecialties() {
    window.app.showToast('Minhas Especialidades - Funcionalidade em desenvolvimento', 'info');
    window.app.closeProviderSidebar();
}

function showEarnings() {
    window.app.showToast('Financeiro - Funcionalidade em desenvolvimento', 'info');
    window.app.closeProviderSidebar();
}
